...
If any identifying detail (name, employer, branch, rank, clearance, exact dates, country, publication) appears in the source material below, omit it from your output entirely - describe only what the capability demonstrates, never who held it or where it happened.
